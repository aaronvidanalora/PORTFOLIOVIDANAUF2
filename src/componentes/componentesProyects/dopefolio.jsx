...
export function Dopefolio() {
    return (
        <div className=" mt-2 mb-5">
          <div className="sm:columns-2 mt-12 ml-12">
                <img className="p-12" src="/dopefolio.jpeg" alt="" />
                <div className="pt-6 sm:w-2/3">
                <h1 className="mt-16 font-bold text-3xl sm:text-left">Dopefolio
                </h1>
                <p className="text-gray-700 mt-6 sm:text-left">
                ...
                <div className="sm:text-left mt-6 ">
                    <button className="py-5 px-14 font-bold text-xl text-white bg-purple-600 rounded-md shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50">
                        CASE STUDY
                    </button>
                </div>
                </div>
          ...
          <div className="sm:columns-2 mt-12 ml-12">
                <img className="p-12" src="/wilsonport.jpeg" alt="" />
                <div className="pt-6 sm:w-2/3">
                <h1 className="mt-16 font-bold text-3xl sm:text-left">Wilsonport
          ...
          <div className="sm:columns-2 mt-12 ml-12">
                <img className="p-12" src="/boreal-coffee-clone.jpeg" alt="" />
                <div className="pt-6 sm:w-2/3">
                <h1 className="mt-16 font-bold text-3xl sm:text-left">Boreal Coffee Clone
          ...
          <div className="sm:columns-2 mt-12 ml-12">
                <img className="p-12" src="/crown-template.jpeg" alt="" />
                <div className="pt-6 sm:w-2/3">
                <h1 className="mt-16 font-bold text-3xl sm:text-left">Crown Template
